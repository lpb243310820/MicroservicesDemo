...
using Lpb.Service1.Web.Subscriber;
...
namespace Lpb.Service1.Web.Startup
{
    public class Startup
    {
        ...
        {
            //Configure DbContext
            services.AddAbpDbContext<Service1DbContext>(options =>
            {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "Service1", Version = "v1" });
            ...
            return services.AddAbp<Service1WebModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "Service1");
