    ...
    public static class ConsulExtension
    {
        ...
        public static IServiceCollection AddConsulServiceDiscovery(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSingleton<IDnsQuery>(p =>
            {
                ...
                return new LookupClient(serviceConfiguration.ConsulDnsEndpoint.ToIPEndPoint());
            });
        ...
        /// <returns></returns>
        public static IApplicationBuilder UseConsulCore2_1(this IApplicationBuilder app)
        {
